/* 
This script will handle the creation of a temp table, which will be used to update data, 
insert data, and delete data. This would in practice be run daily to pick up 
any changes from the underlying tables that form the priority_jobs_snapshot table
*/
...
-- MERGE, will replace the above scripts
